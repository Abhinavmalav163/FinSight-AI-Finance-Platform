       ...
       return(
          <div className="mt-40">
            ...
            <section className="py-20">
              <div className="container mx-auto px-4">
              <h2 className="text-3xl font-bold ytext-center mb-12">Everything you need to manage finances</h2>
            ...
            <section className="py-20">
              <div className="container mx-auto px-4">
              <h2 className="text-3xl font-bold ytext-center mb-12">What Our Users Say</h2>
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
